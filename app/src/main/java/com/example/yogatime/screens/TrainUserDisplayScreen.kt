...
//                    DisplayUserRegisterForTrain(it)
                    DisplayUserData(value = currnetTrain.EventName,
                        label = "Train Name",
                        onTextSelected = {trainUserDisplayViewModel.onEvent(TrainUserDisplayUIState.TrainNameChanged(it))}  ,
                        errorStatus =trainUserDisplayViewModel.editTrainDataUiState.value.EventNameError)
                    DisplaydateforTrain(value = currnetTrain.EventDate, labelValue = "Event Date",
                        onDateSelected = {trainUserDisplayViewModel.onEvent(TrainUserDisplayUIState.DateChanged(it))},
                        errorStatus = trainUserDisplayViewModel.editTrainDataUiState.value.EventDateError)
                    DisplayTrainTime(value = it.EventTime , labelValue = "Event Time",
                        onTimeSelected = {
                            trainUserDisplayViewModel.onEvent(TrainUserDisplayUIState.TimeChanged(it)) },
                    ...
                    DisplayNumberOfParticipanteforTrain(
                        ...
                        onTextSelected = {trainUserDisplayViewModel.onEvent(TrainUserDisplayUIState.NumberOfParticipantesChanged(it))},
                    ...
                    SmallButtonComponent(value = "Save",
                        onButtonClicked = {trainUserDisplayViewModel.onEvent(TrainUserDisplayUIState.EditButtonClicked(currnetTrain)) },
                        isEnabled = trainUserDisplayViewModel.allValidationsPassed.value)

                    SmallButtonComponent(value = "Back",
                        onButtonClicked = {trainUserDisplayViewModel.onEvent(TrainUserDisplayUIState.BackButtonClicked) })

                    SmallButtonComponent(value = "delete",
                        onButtonClicked = {trainUserDisplayViewModel.onEvent(TrainUserDisplayUIState.DeleteButtonClicked(currnetTrain)) })
